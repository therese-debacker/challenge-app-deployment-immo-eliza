...
class CleaningDatasets:
    ...
    def new_columns_sum(self, df: pd.DataFrame, group: str, column: str, new_column: str) -> pd.DataFrame:
        """
    ...
    def new_columns_mean(self, df: pd.DataFrame, group: str, column: str, new_column: str) -> pd.DataFrame:
        """
    ...
    def replace_elements(self, df: pd.DataFrame, column: str, element: str, replaced: str) -> pd.DataFrame:
        """
